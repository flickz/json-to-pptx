...
class ConversionConsumer:
    ...
    def __init__(self):
        ...
        logger.info(f"Consumer initialized with queue: {self.queue_name}")
    ...
    def process_message(self, ch, method, properties, body):
        ...
        try:
            ...
            logger.info(f"Slide dimensions: {slide_width}x{slide_height} inches")
            ...
            slide_count = len(generator.presentation.slides) if hasattr(generator, 'presentation') else 0
