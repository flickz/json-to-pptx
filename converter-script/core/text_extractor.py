...
class ContentExtractor:
    ...
    def extract_from_html(self, html_content: str, base_formats: Dict[str, bool] = None) -> ProcessedText:
    ...
    def _process_element(self, element, processed: ProcessedText, current_formats: Dict[str, Any]):
    ...
    def extract_content(self, text_widget) -> ExtractedContent:
        ...
        html_content = getattr(text_widget, 'html_content', '') or getattr(text_widget, 'text', '')
